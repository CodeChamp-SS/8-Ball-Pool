...
export default class Scene_8BallPool extends Phaser.Scene
{
    ...
    private ballCategory : number = 0
    private cueCategory : number = 0
    private cueBallCategory : number = 0
    private cushionCategory : number = 0
    private potCategory : number = 0

    private balls = []
    private cue?: Phaser.Physics.Matter.Sprite
    private cueBallCollidesWith: number[] = []
    private cueBall?: any 
    private cueSpeed:number = 0
	...
	async create(data: IGameSceneData)
	{
        ...
        console.log("server service data",this.server)
